    ...
    const bannerContent = <>
        <div className="absolute h-full left-0 top-0 right-0 bg-[#050505] bg-opacity-70">
            <div className='absolute md:w-[2/4]  space-y-5 top-10 left-24 right-12 md:right-0  md:left-[calc(50%-300px)] md:top-[calc(50%-150px)]'>
                <h2 className='text-xl text-[#d6d4d4] font-bold sm:text-3xl md:text-4xl' >Discover a Universe <br /> of Language Learning</h2>
                <p className='hidden text-[#d6d4d4] sm:block'>Embrace the world, one language at a time, and unlock a universe of possibilities. <br />Discover the beauty of language and broaden your horizons <br /> with our immersive learning experience</p>
                <div>
