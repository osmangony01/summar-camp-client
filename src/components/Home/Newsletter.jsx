            ...
            <div className="w-full px-6 md:px-0 md:w-4/5 lg:w-3/4 mx-auto">
                ...
                <div className="w-full lg:w-2/3 mx-auto">
                    <div className="flex justify-center">
                        <input className='w-2/4 box-border py-2 md:py-2.5  px-3  outline-none bg-white border border-orange-300 hover:border-orange-500 placeholder:text-sm' placeholder="Enter your email address"/>
                        <span type='submit' className="border-box flex items-center bg-orange-600 border-0 px-5 py-2.5 text-base lg:text-md font-semibold text-white hover:bg-orange-800"><FaRegUser></FaRegUser><span className="pl-2 flex">Subscribe <span className="hidden sm:block pl-2">Now</span></span></span>
                    </div>
                </div>
            </div>
        </div>
