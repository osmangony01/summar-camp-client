    ...
    return (
        <div className='bg-base-200 py-32 '>
            <div className="w-full px-6 md:px-0 md:w-4/5 lg:w-3/4 mx-auto">
                ...
                <div className='text-center px-0 md:px-20 lg:px-40 pb-6'>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</div>
                <div className="w-full lg:w-2/3 mx-auto">
                    <div className="flex justify-center">
                        ...
                        <span type='submit' className="border-box flex items-center bg-orange-600 border-0 px-5 py-2.5 text-base lg:text-xl font-semibold text-white hover:bg-orange-700"><FaRegUser></FaRegUser><span className="pl-2">Subscribe Now</span></span>
                    </div>
                </div>
            </div>
        </div>
